...
public class EC2PublicAccessPortWithTargetRuleTest {
    ...
    public void executeTest() throws Exception {
        ...
        when(PacmanUtils.isAccessbleToAll(anyObject(),anyInt(),anyString(),anyString())).thenReturn(CommonTestUtils.getLinkedHashMapBoolean("123"));
        ...
        when(PacmanUtils.isAccessbleToAll(anyObject(),anyInt(),anyString(),anyString())).thenThrow(new Exception());
        assertThatThrownBy( 
