...
public interface Constants {
    ...
    String CISSCOREINDEX = "cisscore";
   	String GROUPNAME = "groupName";    
   	String S3_MACIE_ENABLED_POLICY="PacMan_S3MacieEnabledRule_version-1";
   	String S3_MACIE_ALERTS_POLICY="PacMan_S3MacieAlertsRule_version-1";
   	String ROOTCAUSE="rootCause";
   	String STACKTRACE="stackTrace";
   	String UP = "UP";
   	String DOWN = "DOWN";
   	String SAME = "SAME";
   	String INTERVAL_NAME = "name";
   	String INTERVAL_ID = "id";
   	String INTERVAL_HR = "hr";
   	String TIME_INTERVAL = "timeinterval";
   	String ISSUE_STATUS_OPENCLOSED = "OPENCLOSED";
