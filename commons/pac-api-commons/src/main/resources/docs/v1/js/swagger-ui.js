(function() {
    ...
    !function() {
        ...
        t.basic_auth = e({
            ...
            5: function(e, t, n, r, i) {
                return '                <input required placeholder="Enter Username" autocomplete="off" class="basic_auth__username auth_input" name="username" type="text"/>\n'
            },
            7: function(e, t, n, r, i) {
                return '            <div class="auth_label">\n                <span class="basic_auth__label" data-sw-translate>Password:</span>\n                <input required placeholder="Enter Password" autocomplete="off" class="basic_auth__password auth_input" name="password" type="password"/></label>\n            </div>\n'
            },
            compiler: [7, ">= 4.0.0"],
            main: function(e, t, n, r, i) {
                var a, o = null != t ? t : {};
        ...
        return function n(e, t, r) {
            ...
            2: [function(e, t, n) {
                ...
                c.prototype.apply = function(e) {
                	return "undefined" == typeof e.headers.Authorization && (e.headers.Authorization = "Bearer " + this.password),
            ...
            24: [function(e, t, n) {
                ...
                function C(e) {
                    ...
                    o) {
                        do
                            i = e.input.charCodeAt(++e.position);
                        while (0 !== i && 62 !== i);e.position < e.length ? (r = e.input.slice(t, e.position),
    ...
    window.SwaggerUi = Backbone.Router.extend({
        ...
        initialize: function(e) {
            ...
            this.options.progress = function(e) {
                return t.showMessage(e, 'progress')
            }
            ,
        ...
        render: function() {
            var e;
            switch (this.showMessage("Finished Loading Resource Information. Rendering Swagger UI...", 'completed'),
        ...
        showMessage: function(e, status) {
        	$("#pacman-api-loading-failed").hide();
            void 0 === e && (e = "");
            var t = $("#message-bar");
           ...
           // t.addClass("message-success"),
            ...
            if(status==='progress') {
	            ...
	            var appValue = this.options.text;
	            appValue = appValue.replace('Service', 'API Service');
	            appName.text(appValue);
	            window.SwaggerTranslator && window.SwaggerTranslator.translate(appName);
	            $(".pacman-api-loading").show();
            }
            if(status==='completed') {
            	$(".pacman-api-loading").hide();
            }
        },
        onLoadFailure: function(e) {
        	$(".pacman-api-loading").hide();
            void 0 === e && (e = ""); 	
            var errorMessageBody = '<div class="sa-icon sa-error animateErrorIcon"><span class="sa-x-mark animateXMark"><span class="sa-line sa-left"></span><span class="sa-line sa-right"></span></span></div><div class="pacman-alert-title">Loading Failed</div><div class="pacman-alert-message">Failed in loading <span class="highlight-pink">${appName}</span> !!!</div>';
            var appValue = this.options.text;
            appValue = appValue.replace('Service', 'API Service');
            errorMessageBody = errorMessageBody.replace('${appName}', appValue)
            //$("#message-bar").removeClass("message-success"),
            //$("#message-bar").addClass("message-fail");
            var t = $("#pacman-api-loading-failed").html(errorMessageBody);
            $("#pacman-api-loading-failed").fadeIn();
    ...
    SwaggerUi.Views.AuthView = Backbone.View.extend({
        ...
        authorize: function() {
        	/*this.authsCollectionView.collection.forEach(function(e) {
            	...
            	this.router.api.clientAuthorizations.add(e.get("title"), t)) : "basic" === r ? (n = new SwaggerClient.PasswordAuthorization(e.get("username"),data["access_token"]),
            	this.router.api.clientAuthorizations.add(e.get("title"), n)) : "oauth2" === r && this.handleOauth2Login(e)
        	}, this);
        	this.router.load();*/ 
        	
        	var url = window.location.origin+"/api/auth/user/login";
        	...
        	if(this.authsCollectionView.collection.length > 0) {
        		this.authsCollectionView.collection.forEach(function(e) {
        			...
        			if(authType === 'oauth2') {
        				...
        				var clientAuthorizationsClone = this.router.api.clientAuthorizations;
            			var routerClone = this.router;
            			$.ajax({
            				url: url,
            				headers: {
            				...
            				success: function(data, o2, n13) {
    			                var t, n, r = e.get("type");
    			                "apiKey" === r ? (t = new SwaggerClient.ApiKeyAuthorization(e.get("name"),e.get("value"),e.get("in")),
    			                clientAuthorizationsClone.add(e.get("title"), t)) : "basic" === r ? (n = new SwaggerClient.PasswordAuthorization(e.get("username"),data["access_token"]),
    			                clientAuthorizationsClone.add(e.get("title"), n)) : "oauth2" === r && this.handleOauth2Login(e)
            					routerClone.load();
               				},
            				error: function(errorDetails, o12, i12) {
            					$(".error-message").html('<div class="pacman-erroralert"><span class="pacman-erroralert-closebtn" onclick="this.parentElement.style.display=\'none\';">&times;</span><strong>Authentication failed:</strong> Please check your username and password.</div>')
            				}
            			});
        			}
            	}, this);
        ...
        handleOauth2Login: function(e) {
            ...
            var tokenOrIdToken = 'token';
            var tokenName = 'access_token';
            var scopeValueToCheck = encodeURIComponent(c.join(scopeSeparator));
            if(scopeValueToCheck === 'openid') {
            	tokenOrIdToken = 'id_token';
            	tokenName = 'id_token';
            }
            ...
            if ("oauth2" !== e.get("type") || !h || "implicit" !== h && "accessCode" !== h) {
                ...
                if (e.get("grantTypes")) {
                    ...
                    for (var d in f)
                        ...
                        u = r.loginEndpoint.url + "?response_type="+tokenOrIdToken,
                ...
                r = e.attributes,
                u = r.authorizationUrl + "?response_type=" + ("implicit" === h ? tokenOrIdToken : "code"),
                p.tokenName = t(r) || tokenName,
            ...
            u += "&nonce=5bca61a6-7906-4455-9a3e-03c9c980f007";
    ...
    SwaggerUi.Views.HeaderView = Backbone.View.extend({
        ...
        showCustom: function(e) {
            ...
            this.trigger("update-swagger-ui", {
                ...
                text: $('#select_baseUrl option:selected').text()
            })
        },
