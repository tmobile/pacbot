...
public class TargetTypesController {
	...
	public ResponseEntity<Object> createTargetType(@RequestBody CreateUpdateTargetTypeDetailsRequest targetTypesDetails) {
		try {
			return ResponseUtils.buildSucessResponse(targetTypesService.addTargetTypeDetails(targetTypesDetails));
		} catch (Exception exception) {
			log.error(UNEXPECTED_ERROR_OCCURRED, exception);
			return ResponseUtils.buildFailureResponse(new Exception(UNEXPECTED_ERROR_OCCURRED), exception.getMessage());
		}
	...
	public ResponseEntity<Object> updateTargetType(@RequestBody CreateUpdateTargetTypeDetailsRequest targetTypesDetails) {
		try {
			return ResponseUtils.buildSucessResponse(targetTypesService.updateTargetTypeDetails(targetTypesDetails));
		} catch (Exception exception) {
			log.error(UNEXPECTED_ERROR_OCCURRED, exception);
			return ResponseUtils.buildFailureResponse(new Exception(UNEXPECTED_ERROR_OCCURRED), exception.getMessage());
		}
