...
public class AuthConfig extends WebSecurityConfigurerAdapter {
	...
	public void configure(WebSecurity web) throws Exception {
		...
		web.ignoring().antMatchers("/user/refresh/**");
		/*web.ignoring().antMatchers("/plugin/**");
		web.ignoring().antMatchers("/asset-group-exception/**");
		web.ignoring().antMatchers("/datasource/**");
		web.ignoring().antMatchers("/domains/**");
		web.ignoring().antMatchers("/job-execution-manager/**");
		web.ignoring().antMatchers("/policy/**");
		web.ignoring().antMatchers("/rule/**");
		web.ignoring().antMatchers("/target-types/**");
		web.ignoring().antMatchers("/users/**");
		web.ignoring().antMatchers("/roles/**");
		web.ignoring().antMatchers("/users-roles/**");
		web.ignoring().antMatchers("/awsaccounts/**");*/
